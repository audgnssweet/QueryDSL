...
import static study.querydsl.entity.QTeamDetail.teamDetail;
...
//        return PageableExecutionUtils.getPage(content, pageable, () -> countQuery.fetchCount());
	...
	@Override
	public Member findMemberByIdFetchTeamAndTeamDetail(Long id) {
		return query.selectFrom(member)
			.join(member.team, team).fetchJoin()
			.join(team.teamDetail, teamDetail).fetchJoin()
